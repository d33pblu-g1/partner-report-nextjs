-- ============================================================================
-- Populate Cube Tables from Core Tables (FIXED VERSION)
-- Run this AFTER importing your core data (partners, clients, commissions, etc.)
-- Handles missing columns gracefully
-- ============================================================================

-- First, let's verify the clients table structure
DO $$
BEGIN
  -- Add tier column to clients if it doesn't exist
  IF NOT EXISTS (
    SELECT 1 FROM information_schema.columns 
    WHERE table_name = 'clients' AND column_name = 'tier'
  ) THEN
    ALTER TABLE clients ADD COLUMN tier VARCHAR(50);
    RAISE NOTICE 'Added tier column to clients table';
  END IF;
END $$;
...
RAISE NOTICE '✅ Cube 1/15: cube_partner_dashboard populated';
...
RAISE NOTICE '✅ Cube 2/15: cube_partner_scorecard populated';
...
RAISE NOTICE '✅ Cube 3/15: cube_daily_trends populated';
...
RAISE NOTICE '✅ Cube 4/15: cube_daily_commissions_plan populated';
...
RAISE NOTICE '✅ Cube 5/15: cube_daily_commissions_platform populated';
...
RAISE NOTICE '✅ Cube 6/15: cube_commissions_product populated';
...
RAISE NOTICE '✅ Cube 7/15: cube_commissions_symbol populated';
...
RAISE NOTICE '✅ Cube 8/15: cube_daily_signups populated';
...
RAISE NOTICE '✅ Cube 9/15: cube_daily_funding populated';
...
RAISE NOTICE '✅ Cube 10/15: cube_monthly_deposits populated';

-- ============================================================================
-- 11. CUBE_CLIENT_TIERS - Client distribution by tier (FIXED)
-- ============================================================================
...
RAISE NOTICE '✅ Cube 11/15: cube_client_tiers populated';
...
RAISE NOTICE '✅ Cube 12/15: cube_client_demographics populated';
...
RAISE NOTICE '✅ Cube 13/15: cube_country_performance populated';
...
RAISE NOTICE '✅ Cube 14/15: cube_product_volume populated';
...
RAISE NOTICE '✅ Cube 15/15: cube_badge_progress populated';
